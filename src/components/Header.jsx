...
const Header = () => {
  return (
    <div>
        <nav class="relative bg-gray-800 invisible">
            <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 ">
                ...
                <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                    ...
                    <div class="flex space-x-4">
                        ...
                        <a href="/work" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Work</a>
        ...
        <div className="flex items-center px-10 justify-between bg-slate-900 py-3 text-white">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 text-white p-6 gap-6 font-semibold text-2xl sm:text-sm">
            <div className=" bg-slate-600 p-4 rounded-2xl hover:bg-slate-500 hover:text-red-500">One</div>
            <div className=" bg-slate-600 p-4 rounded-2xl hover:bg-slate-500 hover:text-red-500">Two</div>
            <div className=" bg-slate-600 p-4 rounded-2xl hover:bg-slate-500 hover:text-red-500">Three</div>
